...
public class MinistryOfCulture extends Ministry{
    ...
    public MinistryOfCulture(int countryKey, Minister minister, Context context, Country country) {
        ...
        this.maximumCulturalWorkersLimit = (int) (economy.getLabor_force() * 0.003f);
    ...
    public void statsRandomizer() {
        ...
        monumentsAndEvents = (int) (monumentsAndEventsNeed * (modifierMonumentsAndEvents + (random.nextFloat() * (0.005f - (-0.005f)) + (-0.005f))));
        generalBudgetNeed = (culturalWorkers * 0.2f) + (culturalWorkers * culturalWorkersSalary) + (monumentsAndEvents * 3000f);
